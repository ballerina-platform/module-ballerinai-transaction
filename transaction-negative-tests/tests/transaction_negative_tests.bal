...
public function testTransactionStatement() {
    ...
    "transactional scope is prohibited");
    validateLog(logLines[7], "ERROR", "transaction_stmt_negative.bal:(56:15,56:39)", "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[8], "ERROR", "transaction_stmt_negative.bal:(75:28,75:34)", "commit not allowed here");
    validateLog(logLines[9], "ERROR", "transaction_stmt_negative.bal:(86:21,86:45)", "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[10], "ERROR", "transaction_stmt_negative.bal:(89:28,89:34)", "commit not allowed here");
...
public function testTransactionOnFail() {
    ...
    validateLog(logLines[2], "ERROR", "transaction_on_fail_negative.bal:(32:6,32:35)", "unreachable code");
    validateLog(logLines[3], "ERROR", "transaction_on_fail_negative.bal:(48:4,50:5)", "incompatible error " +
    "definition type: 'ErrorTypeA' will not be matched to 'ErrorTypeB'");
    validateLog(logLines[4], "ERROR", "transaction_on_fail_negative.bal:(80:7,80:42)", "unreachable code");
    validateLog(logLines[5], "ERROR", "transaction_on_fail_negative.bal:(96:7,96:76)", "unreachable code");
}
