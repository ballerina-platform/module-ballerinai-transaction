...
public function testTransactionStatement() {
    ...
    "transactional scope is prohibited");
    validateLog(logLines[7], "ERROR", "transaction_stmt_negative.bal:(56:15,56:39)",
    ...
    validateLog(logLines[10], "ERROR", "transaction_stmt_negative.bal:(132:9,136:10)",
    ...
    validateLog(logLines[12], "ERROR", "transaction_stmt_negative.bal:(138:13,138:19)",
    "commit cannot be used outside a transaction statement");
    validateLog(logLines[13], "ERROR", "transaction_stmt_negative.bal:(148:17,148:26)",
    "continue statement cannot be " +
    "used to exit from a transaction without a commit or a rollback statement");
    validateLog(logLines[14], "ERROR", "transaction_stmt_negative.bal:(163:17,163:29)",
    "return statement cannot be used " +
    "to exit from a transaction without a commit or a rollback statement");
    validateLog(logLines[15], "ERROR", "transaction_stmt_negative.bal:(180:13,180:20)",
    "return statement cannot be used " +
    "to exit from a transaction without a commit or a rollback statement");
    validateLog(logLines[16], "ERROR", "transaction_stmt_negative.bal:(200:21,200:33)",
    "return statement cannot be used " +
    "to exit from a transaction without a commit or a rollback statement");
    validateLog(logLines[17], "ERROR", "transaction_stmt_negative.bal:(204:21,204:33)",
    "return statement cannot be used " +
    "to exit from a transaction without a commit or a rollback statement");
    validateLog(logLines[18], "ERROR", "transaction_stmt_negative.bal:(223:16,223:42)",
    "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[19], "ERROR", "transaction_stmt_negative.bal:(252:9,252:48)",
    "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[20], "ERROR", "transaction_stmt_negative.bal:(253:9,253:44)",
    "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[21], "ERROR", "transaction_stmt_negative.bal:(254:34,254:64)",
    "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[22], "ERROR", "transaction_stmt_negative.bal:(256:17,256:36)",
    "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[23], "ERROR", "transaction_stmt_negative.bal:(289:17,289:27)",
    "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[24], "ERROR", "transaction_stmt_negative.bal:(306:27,306:44)",
    "invoking transactional function " +
    "outside transactional scope is prohibited");
    validateLog(logLines[25], "ERROR", "transaction_stmt_negative.bal:(307:26,307:44)",
    "invoking transactional function " +
    "outside transactional scope is prohibited");
}
